...
public class Grid : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        foreach(TerrainType region in walkableRegions)
        {
            ...
            walkableRegionsDictionary.Add((int) Mathf.Log(region.terrainMask.value, 2), region.terrainPenaly);
        }
